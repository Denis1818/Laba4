...
Конструкторы
Конструктор по умолчанию: Создает уравнение x² = 0


Quadratic1::Quadratic1() : a_(1.0), b_(0.0), c_(0.0) {}
Конструктор с параметрами: Принимает конкретные значения коэффициентов


Quadratic1::Quadratic1(double a, double b, double c)
    : a_(a), b_(b), c_(c) {}
Конструктор копирования: Создает точную копию существующего объекта
...
Функция InputDouble() обеспечивает безопасный ввод:
